class GdcExplorerLib {
    ...
    */
    ...
    async get_clinical_stratification_survival(project){
        let url = `${location.href}/data_release/${project}/clinical/data_cases.json`;
        let r = await fetch( url );
        let dat_cases = await r.json();

        url = `${location.href}/data_release/${project}/clinical/survival_probs.json`;
        r = await fetch( url );
    ...
    async get_methylation_mapping(){
        let url = `${location.href}/data_release/all_mapp.json`;
        let r = await fetch( url );
        let dat = await r.json();
    ...
    async map_fileid_to_caseid(project, datcat){
        ...
        let url = `${location.href}/data_release/${project}/${datcat}/files_metadata.tsv`;
        let r = await fetch( url );
        let dat = await r.text();
    ...
    async map_caseid_to_demovars(project){
        let datcat = "cases";
        datcat = datcat.replaceAll(" ", "-");
        let url = `${location.href}/data_release/${project}/${datcat}/cases_metadata.json`;
        let r = await fetch( url );
    ...
    async get_mutation_info_metrics_stratified(p){
        ...
        let url = `${location.href}/data_release/${p}/${datcat}/general_snprs_info.json`;
        let r = await fetch( url );
        let dat = await r.json();
    ...
    async load_cases_mutation_annotations(project){
        ...
        for(let c of cols_stratification){
            ...
            let url = `${location.href}/data_release/${project}/${datcat}/by_${c}_table_summary.tsv`;
            let r = await fetch( url );
    ...
    async load_pgx_mutation_data(project){
        // Cases
